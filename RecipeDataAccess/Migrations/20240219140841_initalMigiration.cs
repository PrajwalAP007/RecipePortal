...
{
    /// <inheritdoc />
    public partial class initalMigiration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeLanguage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecipeDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecipeVideos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeUploadTbl", x => x.RecipeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeUploadTbl_ApplicationUserid",
